 ...
 */
public class psych_home extends Fragment  {
    double stresslevel;
    Button btn;
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View mView = inflater.inflate(R.layout.fragment_psych_home, container, false);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                View mView1 = inflater.inflate(R.layout.dialog_suggestion, null);
                final EditText suggest = (EditText) mView1.findViewById(R.id.username);
                //final EditText mPassword = (EditText) mView.findViewById(R.id.etPassword);
                Button mLogin = (Button) mView1.findViewById(R.id.suggest);
                ...
                mLogin.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Date date = new Date();
                        Suggestion s = new Suggestion(suggest.getText().toString(), df.format(date));
                        Notification n = new Notification("Your psychologist gave you a suggestion", df.format(date));
                        mDatabase.child(emailUser.replaceAll("[-+.^:,@]", "")).child("Suggestion").child(UUID.randomUUID().toString()).setValue(s);
                        mDatabase.child(emailUser.replaceAll("[-+.^:,@]", "")).child("notifications").child(UUID.randomUUID().toString()).setValue(n);
