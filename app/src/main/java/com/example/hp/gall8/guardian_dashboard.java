 ...
 */
public class guardian_dashboard extends Fragment {
    float avg = 0;
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        readData3(new psych_dash.MyCallback2() {
            @Override
            public void onCallback(String value) {
                ...
                mDatabase.child(pyschEmail.replaceAll("[-+.^:,@]", "")).child("Stress Logs").addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        ...
                        readData1(new psych_dash.MyCallback() {
                            @Override
                        ...
                        readData2(new psych_dash.MyCallback1() {
                            @Override
                            public void onCallback(float value) {
    ...
    public void readData1(final psych_dash.MyCallback myCallback){
    ...
    public void readData2(final psych_dash.MyCallback1 myCallback1){
    ...
    public void readData3(final psych_dash.MyCallback2 myCallback2){
        ...
        dbRef.child(email.replaceAll("[-+.^:,@]", "")).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                Map<String, Object> map = (Map<String, Object>) dataSnapshot.getValue();
                String firstValue = (String) map.get("guardUser");
